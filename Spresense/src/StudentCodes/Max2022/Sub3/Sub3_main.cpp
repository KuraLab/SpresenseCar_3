...
namespace MAX2022
{
    ...
    void Sub3_loop(void){
        ...
        I2C_Send_Encoder(encoder_mul[0],encoder_mul[1],encoder_mul[2],encoder_mul[3]);

        // I2C_Send_PWM_DIR(Motor_TL, , 1);
        // I2C_Send_PWM_DIR(Motor_TR, , 1);
        // I2C_Send_PWM_DIR(Motor_BL, , 1);
        // I2C_Send_PWM_DIR(Motor_BR, , 1);
